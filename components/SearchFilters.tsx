    ...
    return (
        <section className="bg-gray-800">
            <div className="flex justify-between px-2 py-3">
                ...
                <button onClick={toggle} type="button" className="inline-flex pt-2 bg-gray-700 hover:bg-gray-600 focus:outline-none rounded-lg shadow pl-3 pr-4">
            ...
            <form style={{ display: showMe?"block":"none" }}>
                <fieldset className="px-4 py-4 border-t border-gray-900">
                    <div className="flex -mx-2">
                        <label className="block w-1/2 px-2">
                            ...
                            <select className="mt-1 form-select block w-full text-white shadow focus:bg-gray-600">
                                <option className="bg-gray-600">4</option>
                            </select>
                        </label>
                    ...
                    <div className="mt-4">
                        <label>
                            ...
                            <select className="mt-1 form-select block w-full focus:bg-gray-600">
                ...
                <fieldset className="px-4 py-4 border-2 border-gray-900">
